...
// Static article data - same as blogs.jsx
const articles = [
    {
        id: 1,
    ...
    return (
        <div className={style.blogSection}>
            <div className={style.Btitle}>
                ...
                <p className={style.subtitle}>Research, engineering notes, and lessons from building real systems</p>
            </div>
            ...
            {articles.map((article) => (
                <article
                    ...
                    id={article.slug}
                >
                    <img src={article.cover_image} className={style.blogimg} alt={article.title} />
                    <div className={style.blogBox}>
                        <div className={style.categoryBadge}>{article.category}</div>
                        <div className={style.blogTitle}>{article.title}</div>
